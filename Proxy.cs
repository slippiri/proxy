    ...
    public class Proxy
    {
        ...
        public static void Response(NetworkStream clientStream, byte[] httpRequest)
        {
            ...
            try
            {
                ...
                string fullUrl = GetFullUrl(request, host);
                ...
                OutputResponse(httpResponse, fullUrl); 
        ...
        public static string GetFullUrl(string request, string host)
        {
        ...
        public static void OutputResponse(byte[] httpResponse, string url)
        {
